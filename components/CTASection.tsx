    ...
    <section id="demonstracao" className="py-16 md:py-24 bg-white border-b border-aco-light">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          >
            ...
            <div className="space-y-3.5 pt-2">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <span className="text-sm font-bold text-grafite block font-archivo">
          ...
          {/* Right Column: Lead Form with Motion */}
          <motion.div
            initial={{ opacity: 0, y: 15 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
                ...
                {submitted ? (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="text-xs font-mono text-emerald-900 underline pt-2 hover:text-emerald-950 transition-colors"
                    >
                  ...
                  >
                    ...
                    <button
                      type="submit"
                      className="w-full mt-2 inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-[8px] bg-laranja hover:bg-laranja-hover text-white text-sm font-semibold transition-all duration-150 active:scale-[0.98] shadow-none cursor-pointer"
                    >
