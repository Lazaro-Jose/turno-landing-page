  ...
  return (
    <section id="diferenciais" className="py-16 md:py-24 bg-bancada border-b border-aco-light">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* 3 Column Comparison Grid with Stagger */}
        <FadeInStagger className="grid grid-cols-1 md:grid-cols-3 gap-6" staggerDelay={0.1}>
          ...
          <FadeInStaggerItem className="h-full">
            <motion.div
              ...
              className="bg-white border border-aco-light rounded-[8px] p-6 flex flex-col justify-between h-full hover:border-aco transition-colors"
            >
              <div>
          ...
          <FadeInStaggerItem className="h-full">
            <motion.div
              whileHover={{ y: -3 }}
              transition={{ duration: 0.2 }}
              className="bg-[#101418] text-white border-2 border-laranja rounded-[8px] p-6 flex flex-col justify-between h-full relative shadow-xs"
            >
              <div className="absolute -top-3 right-4 bg-laranja text-white text-[10px] font-mono font-bold uppercase px-2.5 py-0.5 rounded-full shadow-xs">
                Padrão Operacional
              </div>
              ...
              <div>
                ...
                <span className="text-xs font-mono text-laranja uppercase tracking-wider block mb-1">
                  Opção 03
                </span>
